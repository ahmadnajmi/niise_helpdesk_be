...
class IncidentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'appendix_file' => 'nullable|array',
            'appendix_file.*' => 'file|mimes:jpg,jpeg,png,mp4,pdf,doc,docx|max:30720',
            'asset_file' => 'nullable|array',
            'asset_file.*' => 'file|mimes:jpg,jpeg,png,mp4,pdf,doc,docx|max:30720',
