<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('web.incident.index')" :active="request()->routeIs('web.incident.index')">
                        {{ __('Incident Details') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logoutweb') }}">
                            ...
                            <x-dropdown-link :href="route('logoutweb')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('web.dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
        ...
        {{-- <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logoutweb') }}">
                    ...
                    <x-responsive-nav-link :href="route('logoutweb')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
